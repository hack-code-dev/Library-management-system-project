...
<html lang="en">
  ...
  <body>
	...
	<a href="#" class="d-block px-3 py-2 text-center text-bold text-white old-bv">BitsVizag</a>
	</div>
  ...
  <span style='position:absolute;margin:12px 0px 0px 10px;color:white;'><b>BitsVizag</b></span>
